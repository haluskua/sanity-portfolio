...
const WorkExperience = (props: Props) => {
  return (
    ...
    >
      ...
      <div className=" w-full flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar  scrollbar-track-orange scrollbar-thumb-[#f7abba]/40 scrollbar-thumb-rounded-lg">
        <ExperienceCard />
        <ExperienceCard />
        <ExperienceCard />
        <ExperienceCard />
