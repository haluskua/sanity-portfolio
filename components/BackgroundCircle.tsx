...
function BackgroundCircle({}: Props) {
  return (
    <div className="relative flex justify-center items-center">
      ...
      <div className="border absolute border-red-300 rounded-full h-[800px] w-[800px] mt-52 border-[#f7abba opacity-20 animate-pulse " />
      <div className="border absolute border-red-300 rounded-full h-[1000px] w-[1000px] mt-52 border-[#f7abba opacity-20 " />
    </div>
  );
}
