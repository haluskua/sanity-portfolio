...
const ExperienceCard = (props: Props) => {
  return (
    <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600] xl:w-[900px] snap-center bg-[#17334d] hover:opacity-100 opacity-40 cursor-pointer duration-200 overflow-hidden">
      <motion.img
        // initial={{ y: -100 }}
        // viewport={{ once: true }}
